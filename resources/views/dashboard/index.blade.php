...
@section('page_title_main_nav', 'Home')
@section('page_title_nav', 'Dashboard')
@section('content')
    <!-- ROW-1 -->
    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="mt-2">
                                    ...
                                    <h2 class="mb-0 number-font">{{\App\Models\User::all()->count()}}</h2>
                                </div>
                                <div class="ms-auto">
                            ...
                            <a href="{{route('dashboard.users.index')}}" class="text-secondary">Show More...</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xl-4">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="mt-2">
                                    <h6 class="">Total Events</h6>
                                    <h2 class="mb-0 number-font">{{\App\Models\Event::all()->count()}}</h2>
                                </div>
                                <div class="ms-auto">
                                    <div class="chart-wrapper mt-1">
                            ...
                            <a href="{{route('dashboard.events.index')}}" class="text-pink">Show More...</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xl-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="mt-2">
                                    ...
                                    <h2 class="mb-0 number-font">{{\App\Models\Ticket::all()->count()}}</h2>
                                </div>
                                <div class="ms-auto">
                                    <div class="chart-wrapper mt-1">
                            ...
                            <a href="{{route('dashboard.events.index')}}" class="text-green">Show More...</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="browser-stats">
                        <div class="row mb-4">
                            <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                <img src="{{asset('backend')}}/assets/images/browsers/chrome.svg" class="img-fluid"
                                     alt="img">
                            </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                <img src="{{asset('backend')}}/assets/images/browsers/opera.svg" class="img-fluid"
                                     alt="img">
                            </div>
                            <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                <div class="d-flex align-items-end justify-content-between mb-1">
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                <img src="{{asset('backend')}}/assets/images/browsers/ie.svg" class="img-fluid"
                                     alt="img">
                            </div>
                            <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                <div class="d-flex align-items-end justify-content-between mb-1">
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                <img src="{{asset('backend')}}/assets/images/browsers/firefox.svg" class="img-fluid"
                                     alt="img">
                            </div>
                            <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                <div class="d-flex align-items-end justify-content-between mb-1">
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                <img src="{{asset('backend')}}/assets/images/browsers/edge.svg" class="img-fluid"
                                     alt="img">
                            </div>
                            <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                <div class="d-flex align-items-end justify-content-between mb-1">
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                <img src="{{asset('backend')}}/assets/images/browsers/safari.svg" class="img-fluid"
                                     alt="img">
                            </div>
                            <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                <div class="d-flex align-items-end justify-content-between mb-1">
                        ...
                        <div class="row">
                            <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                <img src="{{asset('backend')}}/assets/images/browsers/netscape.svg" class="img-fluid"
                                     alt="img">
                            </div>
                            <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                <div class="d-flex align-items-end justify-content-between mb-1">
